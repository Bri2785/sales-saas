...
public class SalessaasTestContainer extends TestContainer {

    public SalessaasTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/bi/salessaas/app.properties",
    ...
    public static class Common extends SalessaasTestContainer {

        public static final SalessaasTestContainer.Common INSTANCE = new SalessaasTestContainer.Common();
